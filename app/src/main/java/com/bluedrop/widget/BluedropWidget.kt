...
import com.bluedrop.widget.ui.ErrorContent
import com.bluedrop.widget.ui.WidgetContent
import kotlinx.coroutines.CoroutineScope
import kotlinx.coroutines.Dispatchers
import kotlinx.coroutines.launch

class BluedropWidget : GlanceAppWidget() {
                    ...
                    context?.let { ctx ->
                        CoroutineScope(Dispatchers.Main).launch {
                            try {
                                ...
                                val glanceIds =
                                    glanceAppWidgetManager.getGlanceIds(BluedropWidget::class.java)
